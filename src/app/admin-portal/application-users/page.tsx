...
import { ArrowLeft, Users, Edit, Save, X, Search, Plus, UserPlus, AlertCircle, Building2, Trash2, CreditCard, Settings } from 'lucide-react';
                ...
                <div>
                  ...
                  {isEditingOrg ? (
                    <div className="flex items-center gap-2">
                      ...
                      <Button variant="outline" onClick={() => { setIsEditingOrg(false); setOrgName(user?.organizations?.display_name || ''); }} disabled={savingOrg}>
                        <X className="h-4 w-4" />
                      </Button>
                    </div>
                  ) : (
                    <div className="flex items-center justify-between">
                      <span className="text-base">{user?.organizations?.display_name || 'Not set'}</span>
                      {isAdmin && (
