...
CREATE TABLE IF NOT EXISTS "public"."azure_credentials" (
...
ALTER TABLE "public"."azure_credentials" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."azure_credentials"
    ADD CONSTRAINT "azure_credentials_pkey" PRIMARY KEY ("id");
...
GRANT ALL ON TABLE "public"."azure_credentials" TO "anon";
GRANT ALL ON TABLE "public"."azure_credentials" TO "authenticated";
GRANT ALL ON TABLE "public"."azure_credentials" TO "service_role";
